...
features = [ 'Cod_Import_Vol', 'Cod_Import_Val', 'Cod_Export_Vol', 'Cod_Export_Val', 'consumption', 'Inflation Rate', 'Maine Temp', 'Mass Temp', 'Maine Unemployment', 'MASS Unemployment',
            'ME Pop', 'MA Pop', 'Mass PI', 'Maine PI', 'Cod_Auction']
